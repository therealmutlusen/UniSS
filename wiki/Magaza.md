...
Canlı: **[Chrome Web Store](https://chromewebstore.google.com/detail/uniss/fdgaihefghcccapchpkfamphcgopoebn)** (item `fdgaihefghcccapchpkfamphcgopoebn`, 2.0.34) ve **[Firefox AMO](https://addons.mozilla.org/firefox/addon/uniss/)** (slug `uniss`, 2.0.34). Edge Add-ons henüz yok; aynı zip, ayrı yükleme. Opera Add-ons sonra. Safari yok.
