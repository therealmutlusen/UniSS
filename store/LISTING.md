...
Live: [Chrome Web Store](https://chromewebstore.google.com/detail/uniss/fdgaihefghcccapchpkfamphcgopoebn) and [Firefox AMO](https://addons.mozilla.org/firefox/addon/uniss/) (2.0.29). Reuse this copy for Edge Add-ons. Do not paste AGENTS.md into a listing.
...
Package: run `./pack.sh` from the extension root. Upload `uniss-2.0.29.zip`. `manifest.json` is at the zip root.
